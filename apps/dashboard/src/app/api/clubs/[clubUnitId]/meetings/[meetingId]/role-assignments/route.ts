...
import { createMeetingRoleAssignmentRequestSchema } from '@toastmasters/contracts';
...
export async function POST(
  ...
  const parsed = createMeetingRoleAssignmentRequestSchema.safeParse(await request.json());
  if (!parsed.success) {
