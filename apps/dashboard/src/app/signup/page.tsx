...
/** The public sandbox-signup link (platform dashboard QR/link) — no club, no invitation needed. */
    ...
    <main className="flex min-h-[80vh] items-center justify-center bg-linear-to-b from-[#FAF3EC] to-[#F3E7DA] px-6 py-16">
      <div className="w-full max-w-sm rounded-3xl border border-[#EBD9C8] bg-white p-8 shadow-[0_20px_60px_-20px_rgba(119,36,50,0.25)] sm:p-10">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-semibold text-[#2A1418]">Try Toastie</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Explore a sample club — meetings, membership, guests, planner, and education. No club,
            no commitment; nothing you do here is saved.
          </p>
        </div>
        <SignupForm />
      </div>
