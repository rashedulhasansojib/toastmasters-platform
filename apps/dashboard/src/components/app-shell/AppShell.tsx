 ...
 * drawer below that. Rendered from the root layout only when a session
 * exists; the login and guest pages fall through to their own layouts.
 */
    ...
    <div className="min-h-screen lg:grid lg:grid-cols-[16rem_1fr]">
      ...
      <div className="flex min-w-0 flex-col">
        <header className="sticky top-0 z-30 flex items-center gap-3 border-b border-border bg-background/95 px-4 py-3 backdrop-blur lg:hidden">
          ...
          <span className="text-sm font-semibold text-[var(--brand)]">Toastmasters</span>
        </header>
