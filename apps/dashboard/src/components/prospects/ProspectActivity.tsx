import type { Meeting, ProspectCommunication, ProspectVisit } from '@toastmasters/contracts';
import {
  CalendarCheckIcon,
  MailIcon,
  MessageCircleIcon,
...
const CHANNEL_ICON: Record<ProspectCommunication['channel'], LucideIcon> = {
  call: PhoneIcon,
 ...
 */
export function ProspectActivity({
  visits,
  communications,
  meetings,
}: {
